...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtraTeamNotification'
        db.create_table('notifications_extrateamnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'])),
            ('team_notification_setting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notifications.TeamNotificationSettings'])),
        ))
        db.send_create_signal('notifications', ['ExtraTeamNotification'])

        # Adding M2M table for field extra_teams on 'TeamNotificationSettings'
        db.create_table('notifications_teamnotificationsettings_extra_teams', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('teamnotificationsettings', models.ForeignKey(orm['notifications.teamnotificationsettings'], null=False)),
            ('team', models.ForeignKey(orm['teams.team'], null=False))
        ))
        db.create_unique('notifications_teamnotificationsettings_extra_teams', ['teamnotificationsettings_id', 'team_id'])

    def backwards(self, orm):
        # Deleting model 'ExtraTeamNotification'
        db.delete_table('notifications_extrateamnotification')

        # Removing M2M table for field extra_teams on 'TeamNotificationSettings'
        db.delete_table('notifications_teamnotificationsettings_extra_teams')
    ...
    models = {
        ...
        'notifications.extrateamnotification': {
            'Meta': {'object_name': 'ExtraTeamNotification'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']"}),
            'team_notification_setting': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['notifications.TeamNotificationSettings']"})
        },
        'notifications.teamnotification': {
            'Meta': {'unique_together': "[('team', 'number')]", 'object_name': 'TeamNotification'},
            'data': ('django.db.models.fields.CharField', [], {'max_length': '5120'}),
        ...
        'notifications.teamnotificationsettings': {
            'Meta': {'object_name': 'TeamNotificationSettings'},
            'auth_password': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'auth_username': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'extra_teams': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'team_settings_extra'", 'symmetrical': 'False', 'to': "orm['teams.Team']"}),
            'header1': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'header2': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'header3': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
