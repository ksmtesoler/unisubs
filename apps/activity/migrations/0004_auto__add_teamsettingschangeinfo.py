...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeamSettingsChangeInfo'
        db.create_table('activity_teamsettingschangeinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changes', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('activity', ['TeamSettingsChangeInfo'])

    def backwards(self, orm):
        # Deleting model 'TeamSettingsChangeInfo'
        db.delete_table('activity_teamsettingschangeinfo')
    ...
    models = {
        ...
        'activity.activityrecord': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 7, 18, 0, 0)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
