...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubtitleLanguageChange'
        db.create_table('activity_subtitlelanguagechange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_language', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
        ))
        db.send_create_signal('activity', ['SubtitleLanguageChange'])

    def backwards(self, orm):
        # Deleting model 'SubtitleLanguageChange'
        db.delete_table('activity_subtitlelanguagechange')
    ...
    models = {
        ...
        'activity.activityrecord': {
            'Meta': {'ordering': "['-created', '-id']", 'object_name': 'ActivityRecord'},
            'copied_from': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'copies'", 'null': 'True', 'to': "orm['activity.ActivityRecord']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 9, 28, 0, 0)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16', 'blank': 'True'}),
            'private_to_team': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'activity.subtitlelanguagechange': {
            'Meta': {'object_name': 'SubtitleLanguageChange'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'old_language': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'})
        },
        'activity.teamsettingschangeinfo': {
            'Meta': {'object_name': 'TeamSettingsChangeInfo'},
