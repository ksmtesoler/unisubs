...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VideoUrl', fields ['url_hash', 'type', 'team_id']
        db.create_unique('videos_videourl', ['url_hash', 'type', 'team_id'])

        # Removing unique constraint on 'VideoUrl', fields ['url_hash', 'type']
        db.delete_unique('videos_videourl', ['url_hash', 'type'])

    def backwards(self, orm):
        # Adding unique constraint on 'VideoUrl', fields ['url_hash', 'type']
        db.create_unique('videos_videourl', ['url_hash', 'type'])

        # Removing unique constraint on 'VideoUrl', fields ['url_hash', 'type', 'team_id']
        db.delete_unique('videos_videourl', ['url_hash', 'type', 'team_id'])
