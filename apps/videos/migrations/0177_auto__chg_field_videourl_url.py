...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoUrl.url'
        db.alter_column('videos_videourl', 'url', self.gf('django.db.models.fields.URLField')(max_length=2048))
    def backwards(self, orm):

        # Changing field 'VideoUrl.url'
        db.alter_column('videos_videourl', 'url', self.gf('django.db.models.fields.URLField')(max_length=512))
    models = {
        'auth.customuser': {
