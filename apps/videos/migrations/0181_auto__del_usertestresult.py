...
class Migration(SchemaMigration):
    # This migration just fixes the south metadata that's stored in the DB.
    # Right now the videos.usertestresult table is there, even though the
    # actual table was deleted
