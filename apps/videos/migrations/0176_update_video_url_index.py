...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Delete the old index on (url, type)
        db.execute('ALTER TABLE videos_videourl DROP INDEX url_type')
    ...
    def backwards(self, orm):
        ...
        # Recreate old index on (url, type)
        db.execute('ALTER TABLE videos_videourl '
