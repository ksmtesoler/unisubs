...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.team_visibility'
        db.add_column('teams_team', 'team_visibility',
                      self.gf('utils.enum.EnumField')(default=3),
                      keep_default=False)

        # Adding field 'Team.video_visibility'
        db.add_column('teams_team', 'video_visibility',
                      self.gf('utils.enum.EnumField')(default=3),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Team.team_visibility'
        db.delete_column('teams_team', 'team_visibility')

        # Deleting field 'Team.video_visibility'
        db.delete_column('teams_team', 'video_visibility')
    ...
    models = {
        ...
        'teams.team': {
            ...
            'team_visibility': ('utils.enum.EnumField', [], {'default': '3'}),
            ...
            'video_visibility': ('utils.enum.EnumField', [], {'default': '3'}),
