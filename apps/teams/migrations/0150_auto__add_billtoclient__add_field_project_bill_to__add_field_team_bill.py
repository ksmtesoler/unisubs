...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BillToClient'
        db.create_table('teams_billtoclient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('teams', ['BillToClient'])

        # Adding field 'Project.bill_to'
        db.add_column('teams_project', 'bill_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.BillToClient'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Team.bill_to'
        db.add_column('teams_team', 'bill_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.BillToClient'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'BillToClient'
        db.delete_table('teams_billtoclient')

        # Deleting field 'Project.bill_to'
        db.delete_column('teams_project', 'bill_to_id')

        # Deleting field 'Team.bill_to'
        db.delete_column('teams_team', 'bill_to_id')
    ...
    models = {
        'auth.customuser': {
            ...
            'picture': ('utils.amazon.fields.S3EnabledImageField', [], {'max_length': '100', 'thumb_sizes': '[(110, 110), (100, 100), (50, 50), (30, 30)]', 'blank': 'True'}),
