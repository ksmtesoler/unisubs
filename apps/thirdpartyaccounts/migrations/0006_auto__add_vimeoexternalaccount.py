...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VimeoExternalAccount'
        db.create_table('thirdpartyaccounts_vimeoexternalaccount', (
            ...
            ('access_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('thirdpartyaccounts', ['VimeoExternalAccount'])

    def backwards(self, orm):
        # Deleting model 'VimeoExternalAccount'
        db.delete_table('thirdpartyaccounts_vimeoexternalaccount')
    ...
    models = {
        ...
        'thirdpartyaccounts.vimeoexternalaccount': {
            'Meta': {'object_name': 'VimeoExternalAccount'},
            'access_code': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.CustomUser']"}),
