...
urlpatterns = patterns('thirdpartyaccounts.views',
    ...
    url(r'^vimeo_login/$', 'vimeo_login', name='vimeo_login'),
    url(r'^vimeo_login_done/$', 'vimeo_login_done', name='vimeo_login_done'),
    url(r'^vimeo_login_confirm/$', 'vimeo_login', {'confirmed': False}, name='vimeo_login_confirm'),
    url(r'^vimeo_login_done_confirm/$', 'vimeo_login_done', {'confirmed': False}, name='vimeo_login_done_confirm'),
