...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('auth_customuser', 'picture', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, thumb_sizes=[(240, 240), (110, 110), (100, 100), (50, 50), (30, 30)]))
    def backwards(self, orm):

        # Changing field 'CustomUser.picture'
        db.alter_column('auth_customuser', 'picture', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, thumb_sizes=[(110, 110), (100, 100), (50, 50), (30, 30)]))
    models = {
        'auth.announcement': {
