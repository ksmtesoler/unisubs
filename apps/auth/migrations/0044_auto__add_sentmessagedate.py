...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SentMessageDate'
        db.create_table('auth_sentmessagedate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('auth', ['SentMessageDate'])


    def backwards(self, orm):
        # Deleting model 'SentMessageDate'
        db.delete_table('auth_sentmessagedate')
