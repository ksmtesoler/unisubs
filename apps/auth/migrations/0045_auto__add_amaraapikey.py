...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AmaraApiKey'
        db.create_table('auth_amaraapikey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='amara_api_key', unique=True, to=orm['auth.CustomUser'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('key', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
        ))
        db.send_create_signal('auth', ['AmaraApiKey'])

    def backwards(self, orm):
        # Deleting model 'AmaraApiKey'
        db.delete_table('auth_amaraapikey')

    models = {
        'auth.amaraapikey': {
            'Meta': {'object_name': 'AmaraApiKey'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'amara_api_key'", 'unique': 'True', 'to': "orm['auth.CustomUser']"})
        },
        'auth.announcement': {
        ...
        'auth.sentmessagedate': {
            'Meta': {'object_name': 'SentMessageDate'},
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.CustomUser']"})
        },
