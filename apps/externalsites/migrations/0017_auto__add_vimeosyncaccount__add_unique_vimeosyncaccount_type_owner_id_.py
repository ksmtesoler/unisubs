...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VimeoSyncAccount'
        db.create_table('externalsites_vimeosyncaccount', (
            ...
            ('import_team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True, blank=True)),
            ('sync_subtitles', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('fetch_initial_subtitles', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('externalsites', ['VimeoSyncAccount'])

        # Adding M2M table for field sync_teams on 'VimeoSyncAccount'
        db.create_table('externalsites_vimeosyncaccount_sync_teams', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vimeosyncaccount', models.ForeignKey(orm['externalsites.vimeosyncaccount'], null=False)),
            ('team', models.ForeignKey(orm['teams.team'], null=False))
        ))
        db.create_unique('externalsites_vimeosyncaccount_sync_teams', ['vimeosyncaccount_id', 'team_id'])

        # Adding unique constraint on 'VimeoSyncAccount', fields ['type', 'owner_id', 'username']
        db.create_unique('externalsites_vimeosyncaccount', ['type', 'owner_id', 'username'])

    def backwards(self, orm):
        # Removing unique constraint on 'VimeoSyncAccount', fields ['type', 'owner_id', 'username']
        db.delete_unique('externalsites_vimeosyncaccount', ['type', 'owner_id', 'username'])

        # Deleting model 'VimeoSyncAccount'
        db.delete_table('externalsites_vimeosyncaccount')

        # Removing M2M table for field sync_teams on 'VimeoSyncAccount'
        db.delete_table('externalsites_vimeosyncaccount_sync_teams')
    ...
    models = {
        'auth.customuser': {
            ...
            'picture': ('utils.amazon.fields.S3EnabledImageField', [], {'max_length': '100', 'thumb_sizes': '[(240, 240), (110, 110), (100, 100), (50, 50), (30, 30)]', 'blank': 'True'}),
        ...
        'externalsites.brightcoveaccount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_feed': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['videos.VideoFeed']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'externalsites.brightcovecmsaccount': {
            'Meta': {'unique_together': "[('type', 'owner_id')]", 'object_name': 'BrightcoveCMSAccount'},
        ...
        'externalsites.openidconnectlink': {
            'Meta': {'object_name': 'OpenIDConnectLink'},
            'sub': ('django.db.models.fields.CharField', [], {'max_length': '255', 'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'openid_connect_link'", 'unique': 'True', 'to': "orm['auth.CustomUser']"})
        },
        ...
        'externalsites.vimeosyncaccount': {
            'Meta': {'unique_together': "[('type', 'owner_id', 'username')]", 'object_name': 'VimeoSyncAccount'},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'fetch_initial_subtitles': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']", 'null': 'True', 'blank': 'True'}),
            'owner_id': ('django.db.models.fields.IntegerField', [], {}),
            'sync_subtitles': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'sync_teams': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'vimeo_sync_accounts'", 'symmetrical': 'False', 'to': "orm['teams.Team']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
        ...
        'externalsites.youtubeaccount': {
            ...
            'enable_language_mapping': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'fetch_initial_subtitles': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']", 'null': 'True', 'blank': 'True'}),
            'last_import_video_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'oauth_refresh_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner_id': ('django.db.models.fields.IntegerField', [], {}),
            'sync_subtitles': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'sync_teams': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'youtube_sync_accounts'", 'symmetrical': 'False', 'to': "orm['teams.Team']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'teams.billtoclient': {
            'Meta': {'object_name': 'BillToClient'},
            'client': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'teams.partner': {
        ...
        'teams.project': {
            ...
            'bill_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.BillToClient']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'teams.team': {
            ...
            'prevent_duplicate_public_videos': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
