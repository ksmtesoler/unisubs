...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouTubeAccount.sync_subtitles'
        db.add_column('externalsites_youtubeaccount', 'sync_subtitles',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'YouTubeAccount.fetch_initial_subtitles'
        db.add_column('externalsites_youtubeaccount', 'fetch_initial_subtitles',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'YouTubeAccount.sync_subtitles'
        db.delete_column('externalsites_youtubeaccount', 'sync_subtitles')

        # Deleting field 'YouTubeAccount.fetch_initial_subtitles'
        db.delete_column('externalsites_youtubeaccount', 'fetch_initial_subtitles')
