...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrightcoveCMSAccount'
        db.create_table('externalsites_brightcovecmsaccount', (
            ...
            ('client_secret', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('externalsites', ['BrightcoveCMSAccount'])

        # Adding unique constraint on 'BrightcoveCMSAccount', fields ['type', 'owner_id']
        db.create_unique('externalsites_brightcovecmsaccount', ['type', 'owner_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'BrightcoveCMSAccount', fields ['type', 'owner_id']
        db.delete_unique('externalsites_brightcovecmsaccount', ['type', 'owner_id'])

        # Deleting model 'BrightcoveCMSAccount'
        db.delete_table('externalsites_brightcovecmsaccount')
